...
#SOURCE_DIRS += $(PROJECT_APP)/no-OS/drivers/adc/ad7768-1 // TODO - uncomment when no-os driver bug is fixed
...
#SOURCE_INCLUDE_PATHS += $(PROJECT_APP)/no-OS/drivers/adc/ad7768-1 // TODO - uncomment when no-os driver bug is fixed
